...
//<--validaciones-->
    ...
    $('.table-validaciones').on('click', 'button[name="Validacion"]', function () {
        var titulo = "Historial Validaciones";

        $.ajax({
            type: 'GET',
            url: '/Validaciones/Historial',
            data: { escuela: $(this).val() },
            beforeSend: function () {
            },
            complete: function () {
            },
    ...
    $('#cerrar').click(function () {
        $.ajax({
            type: 'POST',
            url: '/Validaciones/CerrarValidacion',
            data: { id: $('#validacion_IdValidar').val() },
            beforeSend: function () {
            },
            complete: function () {
            },
...
$("#fileexe").on("change", function () {

    var data = new FormData();
    var file = document.getElementById('fileexe').files[0];
    data.append('file', file)
    ...
    $("#fileexcelm").on("change", function () {
        ...
        var data = new FormData();
        var file = document.getElementById('fileexcelm').files[0];
        data.append('file', file)
